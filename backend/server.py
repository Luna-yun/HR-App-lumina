...
@api_router.get("/")
async def root():
    return {"message": "LuminaHR API - Employee Management System"}
...
api_router.include_router(salary_router, tags=["Salary"])
api_router.include_router(notice_router, tags=["Notices"])
api_router.include_router(department_router, tags=["Departments"])
